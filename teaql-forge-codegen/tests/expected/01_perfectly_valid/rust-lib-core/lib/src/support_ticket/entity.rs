...
#[teaql(entity = "SupportTicket", table = "support_ticket_data", data_service = "sqlite")]
pub struct SupportTicket {
#[teaql(id)]
    id: u64,
// @source 01_perfectly_valid.xml:25
    title: String,
// @source 01_perfectly_valid.xml:25
...
#[teaql(column = "status")]
    status_id: u64,
// @source 01_perfectly_valid.xml:25
#[teaql(relation(target = "TicketStatus", local_key = "status_id", foreign_key = "id"))]
    status: Option<crate::TicketStatus>,
#[teaql(relation(target = "CustomerIssue", local_key = "id", foreign_key = "ticket_id", many))]
    customer_issue_list: SmartList<crate::CustomerIssue>,
    #[teaql(dynamic)]
...
impl SupportTicket {
    ...
    pub(crate) fn runtime_new(root: teaql_runtime::EntityRoot) -> Self {
        Self {
            ...
            status_id: 0_u64,
            status: None,
            customer_issue_list: Default::default(),
    ...
    pub fn entity_key(&self) -> teaql_runtime::EntityKey {
        teaql_runtime::EntityKey::new("SupportTicket", self.id)
    }
    pub fn attach_root_recursive(&mut self, root: teaql_runtime::EntityRoot) {
        ...
        for entity in &mut self.customer_issue_list {
            entity.attach_root_recursive(root.clone());
        }
    }
    ...
    pub fn update_status_to_resolved(&mut self) -> &mut Self {
        self.update_status_id(1002_u64)
    }
    pub fn status_is_resolved(&self) -> bool {
        self.status_id() == 1002_u64
    }
    pub fn status(&self) -> Option<&crate::TicketStatus> {
        self.status.as_ref()
    }
    pub fn eval_status(&self) -> teaql_core::eval::EvalResult<&crate::TicketStatus> {
    ...
    pub fn customer_issue_list(&self) -> &SmartList<crate::CustomerIssue> {
        &self.customer_issue_list
    }
    pub fn customer_issue_list_mut(&mut self) -> &mut SmartList<crate::CustomerIssue> {
        &mut self.customer_issue_list
    }
    pub fn eval_customer_issue_list(&self) -> teaql_core::eval::EvalResult<&SmartList<crate::CustomerIssue>> {
        if !self.is_loaded("customer_issue_list") {
            teaql_core::eval::EvalResult::NotLoaded { failed_node: "customer_issue_list".to_string(), attempted_path: "customer_issue_list".to_string() }
        } else {
            teaql_core::eval::EvalResult::Value(&self.customer_issue_list)
        }
    }
    ...
    pub(crate) async fn save<'a, C>(
        &self,
        ctx: &'a C,
    ) -> Result<teaql_runtime::GraphNode, crate::TeaqlDataServiceError<C::SupportTicketRepository<'a>>>
    where
        C: crate::TeaqlRepositoryProvider + ?Sized,
    {
        ...
        if has_ledger_change {
            ...
            return Ok(teaql_runtime::GraphNode::new("SupportTicket"));
        }
