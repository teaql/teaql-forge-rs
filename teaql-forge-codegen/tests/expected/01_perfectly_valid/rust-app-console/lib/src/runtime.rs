...
pub const DATABASE_URL_ENV: &str = "PERFECT_SERVICE_CORE_DATABASE_URL";
...
impl teaql_data_service::SchemaProvider for LocalSchemaProvider {
    fn get_entity(&self, name: &str) -> Option<std::sync::Arc<teaql_core::EntityDescriptor>> {
        match name {
            "TicketStatus" => Some(std::sync::Arc::new(crate::TicketStatus::entity_descriptor())),
            "SupportTicket" => Some(std::sync::Arc::new(crate::SupportTicket::entity_descriptor())),
            "CustomerIssue" => Some(std::sync::Arc::new(crate::CustomerIssue::entity_descriptor())),
            _ => None,
        }
    }
}
...
pub async fn service_runtime_from_pool(pool: DataServicePool) -> Result<ServiceRuntime, ServiceRuntimeError> {
    ...
    let env_config = teaql_tool_core::audit_config_from_env(&[
        "ticket_status_data", "support_ticket_data", "customer_issue_data"
    ]);
...
pub fn repository_registry() -> teaql_runtime::InMemoryRepositoryRegistry {
    teaql_runtime::InMemoryRepositoryRegistry::new()
        .with_entity("TicketStatus")
        .with_entity("SupportTicket")
        .with_entity("CustomerIssue")
}
...
pub fn behavior_registry() -> teaql_runtime::InMemoryRepositoryBehaviorRegistry {
    teaql_runtime::InMemoryRepositoryBehaviorRegistry::new()
        .with_behavior("TicketStatus", TicketStatusBehavior::default())
        .with_behavior("SupportTicket", SupportTicketBehavior::default())
        .with_behavior("CustomerIssue", CustomerIssueBehavior::default())
}

pub fn checker_registry() -> teaql_runtime::InMemoryCheckerRegistry {
    teaql_runtime::InMemoryCheckerRegistry::new()
        .with_checker(teaql_runtime::TypedEntityChecker::<TicketStatus, _>::new(TicketStatusChecker::default()))
        .with_checker(teaql_runtime::TypedEntityChecker::<SupportTicket, _>::new(SupportTicketChecker::default()))
        .with_checker(teaql_runtime::TypedEntityChecker::<CustomerIssue, _>::new(CustomerIssueChecker::default()))
}
...
pub fn module() -> teaql_runtime::RuntimeModule {
    teaql_runtime::RuntimeModule::new()
        ...
        .entity::<CustomerIssue>()
        .initial_graph(teaql_runtime::GraphNode::new("TicketStatus")
            .value("id", 1_u64)
            .value("name", "Pending")
            .value("code", "PENDING")
            .value("version", 1_i64))
...
pub fn module_with_checkers() -> teaql_runtime::RuntimeModule {
    teaql_runtime::RuntimeModule::new()
        .entity::<TicketStatus>()
        .checker(teaql_runtime::TypedEntityChecker::<TicketStatus, _>::new(TicketStatusChecker::default()))
        .entity::<SupportTicket>()
        .checker(teaql_runtime::TypedEntityChecker::<SupportTicket, _>::new(SupportTicketChecker::default()))
        .entity::<CustomerIssue>()
        .checker(teaql_runtime::TypedEntityChecker::<CustomerIssue, _>::new(CustomerIssueChecker::default()))
        .initial_graph(teaql_runtime::GraphNode::new("TicketStatus")
            .value("id", 1_u64)
            .value("name", "Pending")
            .value("code", "PENDING")
...
pub fn module_with_behaviors() -> teaql_runtime::RuntimeModule {
    teaql_runtime::RuntimeModule::new()
        .entity_with_behavior::<TicketStatus, _>(TicketStatusBehavior::default())
        .entity_with_behavior::<SupportTicket, _>(SupportTicketBehavior::default())
        .entity_with_behavior::<CustomerIssue, _>(CustomerIssueBehavior::default())
        .initial_graph(teaql_runtime::GraphNode::new("TicketStatus")
            .value("id", 1_u64)
            .value("name", "Pending")
            .value("code", "PENDING")
