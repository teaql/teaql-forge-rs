Please help me complete the delete (Soft Delete) service business code for the `Platform` object.

To ensure absolute correctness of the API, please refer to and strictly imitate the following **real soft delete code example for `Platform`**.
...
) -> Result<bool, Box<dyn std::error::Error>>
{
    ...
    if let Some(mut existing_entity) = Q::platforms_minimal()
        ...
        .purpose("what: Find entity for soft deletion")
        .comment("why: Need to execute soft delete")
        .execute(ctx)
        .await?
    {
...
### Your Task
Please completely imitate the framework, imports, and syntax features of the above code to implement the real soft delete logic for `Platform` based on my specific business needs. Please output the Rust source code directly.